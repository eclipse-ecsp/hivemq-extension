...
/**
 * It gets the VehicleId from VehicleProfile service over HTTP.
 */
public class DeviceToVehicleMapperVpImpl implements DeviceToVehicleMapper {
    private static final IgniteLogger LOGGER = IgniteLoggerFactory.getLogger(DeviceToVehicleMapperVpImpl.class);
    private static final int RETRY_COUNT = 2;
    private static final int SLEEP_BEFORE_RETRY = 10;

    public DeviceToVehicleMapperVpImpl() {
    ...
    /**
        * Initializes the DeviceToVehicleMapperVpImpl with the given properties.
        *
