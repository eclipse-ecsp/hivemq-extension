...
/**
 * This interface defines a method which can extract any data from vehicle profile response and put in client
 * connection attribute store.
 */
public interface VehicleProfileDataExtraction {
