...
/**
 * Test CertificateAuthentication class. This class authenticates via TLS
 * certificate.
 */
...
public class CertificateAuthenticationTest {
    private CertificateAuthentication certAuthentication;
    @Mock
    ...
    public void setup() {
        ...
        try {
            ...
            certAuthentication = new CertificateAuthentication();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /**
     * Testing authenticate() when tls information not present.
     */
    @Test
    ...
    public void testAuthenticateWhenValidCertForNew2WayTls_Success_device() throws Exception {
        ...
        CertificateAuthentication certObj = new CertificateAuthentication();
     ...
     *
     * @param days        the number of days for the certificate validity
