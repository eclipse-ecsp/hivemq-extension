...
`eclipse-ecsp/hivemq-extension` up to date and always improving! There are a few guidelines that we need
contributors to follow to keep the project consistent, as well as allow us to keep
maintaining `eclipse-ecsp/hivemq-extension` in a reasonable amount of time.
...
1. Please make sure there is no [open issue](https://github.com/eclipse-ecsp/hivemq-extension/issues) yet.
...
- Submit a pull request from your topic branch to the [main](https://github.com/eclipse-ecsp/hivemq-extension) branch on the `eclipse-ecsp/hivemq-extension` repository.
...
- Ensure that the PR is tagged with related [issue](https://github.com/eclipse-ecsp/hivemq-extension/issues) it intends to resolve.
